...
class PeopleFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'people_ibfk_4' => ['type' => 'foreign', 'columns' => ['tenant_id'], 'references' => ['tenants', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
            'people_ibfk_5' => ['type' => 'foreign', 'columns' => ['warehouse_id'], 'references' => ['warehouses', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
...
//                'old_user_id' => 1,
//                'pronoun' => '',
//                'cart_session' => 'afa1d078-19f6-45cc-aeab-fd32c1b2c342',
//                'created' => '2020-03-25 21:44:25',
//                'modified' => '2020-03-25 21:44:25',
//            ],
//        ];
//        parent::init();
    }
